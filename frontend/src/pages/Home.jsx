      ...
      <div className="home-container">
        <div className="content">
          <h1 className="gradient-text">
            {" "}
            <span className="highlight"> Verify </span> certifications with ease{" "}
          </h1>
          ...
          <p className="description">
            ...
            blockchain technology, we ensure that all certificates are
            authentic, tamper-proof, and instantly accessible by employers,
            institutions, and individuals.
          </p>

          <div className="button-group">
            <a href="/validate" className="nav-link active">
              <button className="gradient-button verify-button">
                Verify a Certificate
              </button>
            </a>

            <a href="/issue" className="nav-link active">
              <button className="gradient-button issue-button">
                Issue a Certificate
              </button>
            </a>
          </div>
      ...
      <div className="why-eth">
        ...
        <div className="why first">
          <div className="content">
            ...
            <p>
              ETHcertify provides a fast and reliable way to verify the
              authenticity of resumes and qualifications. Employers can
              instantly confirm that candidates certificates, diplomas, and
              academic records are genuine, reducing the risk of hiring
